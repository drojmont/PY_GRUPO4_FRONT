    ...
    return (
        <div className="min-h-screen bg-gray-50">
                        ...
                        <div className="w-full flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
                            ...
                            <div className="relative w-full md:w-auto">
                                ...
                                {isOpen && (
                                    <div className="absolute z-20 mt-2 w-full md:w-48 bg-white rounded-lg shadow-lg py-2">
                                        <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Festivales</a>
                                        <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Convenciones</a>
                                        <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Conciertos</a>
                                        <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Viajes Familiares</a>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="w-full md:w-96">
                                <div className="bg-white/95 rounded-full shadow-lg flex items-center p-2 px-1">
                                    <input type="text" placeholder="Buscar" className="flex-1 px-1 py-1 bg-transparent focus:outline-none text-gray-700"/>
                                    <button className="p-1 hover:bg-gray-100  rounded-full transition-colors">
                                        <svg className="w-6 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 md:flex-nowrap gap-4">
                    <div className="rounded-lg overflow-hidden shadow-sm">
                        <div className="bg-gray-200 h-48 w-full">
                            <img src={fotoImage} alt=" imagen del producto" className="w-full h-full "/>
                        </div>
            ...
            <section className="py-12 px-4">
                <h2 className="text-lg font-medium text-gray-700 mb-4">Recomendaciones</h2>
                            ...
                            <div className="sm:w-2/3 p-4 flex flex-col justify-between">
                                <div>
                                    <div className="flex justify-between items-start mb-2">
                                        <h3 className="text-gray-700 font-medium">Nombre del producto</h3>
                                    </div>
